...
export function draw(container) {
  ...
  console.log("First: " + monthNow);
  console.log("First: " + yearNow);
...
function drawInput(container, currentYear, currentMonth) {
  ...
  button.onclick = async () =>
    await handleClick(inputYear.value, inputMonth.value); // Prilagodite ovde
...
async function handleClick(year, month) {
  ...
  mn.innerHTML = getMonthName(parseInt(month)); // Proveravamo mesec ovde
